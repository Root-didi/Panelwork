...
import GreyBox from '@/components/elements/GreyBox';
                    ...
                    <Sidebar.Wrapper>
                        ...
                        <GreyBox>
                            ...
                            <p css={tw`text-xs mt-2`}>
                                <FontAwesomeIcon icon={faMicrochip} fixedWidth css={tw`mr-1`}/> 69%
                                <span css={tw`text-neutral-500`}> / 420%</span>
                            </p>
                            <p css={tw`text-xs mt-2`}>
                                <FontAwesomeIcon icon={faMemory} fixedWidth css={tw`mr-1`}/> 4 GB
                                <span css={tw`text-neutral-500`}> / 5 GB</span>
                            </p>
                            <p css={tw`text-xs mt-2`}>
                                <FontAwesomeIcon icon={faHdd} fixedWidth css={tw`mr-1`}/>&nbsp;204 MB
                                <span css={tw`text-neutral-500`}> / 600 MB</span>
                            </p>
                        </GreyBox>
                    </Sidebar.Wrapper>
                    <NavLink to={'/'} css={tw`mt-auto mb-3`}>
                        <FontAwesomeIcon icon={faArrowLeft}/> <span>Dashboard</span>
                    </NavLink>
                    <Sidebar.User>
                        {avatarURL &&
